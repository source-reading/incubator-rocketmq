...
public abstract class NettyRemotingAbstract {
     ...
     */
    protected final ConcurrentHashMap<Integer /* opaque */, ResponseFuture> responseTable = new ConcurrentHashMap<Integer, ResponseFuture>(256);  // 存储请求服务端的连接, key: 递增编号, value: response
