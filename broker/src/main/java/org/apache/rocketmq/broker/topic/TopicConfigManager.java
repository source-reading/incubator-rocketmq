...
public class TopicConfigManager extends ConfigManager {
    ...
    private final ConcurrentHashMap<String /* topics */, TopicConfig> topicConfigTable = new ConcurrentHashMap<String, TopicConfig>(1024);
    private final DataVersion dataVersion = new DataVersion(); // 配置文件版本号 TODO 如何生成
    private final Set<String> systemTopicList = new HashSet<String>(); // 系统默认创建的 topic
